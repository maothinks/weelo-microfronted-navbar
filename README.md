# Weelo Microfrontend Navbar

This microfrontend shows the top header menu-bar and creates a Signalr connection to notify events from server

- Title
- Navigate Options: Properties and Profile pages
- Notifications (Real time views on property)
- SignalR Connection to notify events
